    ...
    return (
        <>
            ...
            <ScrollView contentContainerStyle={styles.container}>
                <View style={styles.titleContainerNav}>
                <View style={styles.titleContainer}>
                        <Icon name="text-snippet" size={24} color="#323232" />
                    <Text style={styles.title}>POSTS</Text>
                </View>
                <View style={styles.titleContainer}>
                        <Icon name="workspaces-outline" size={24} color="#323232" />
                    <Text style={styles.title}>PROJECTS</Text>
                </View>
                <View style={styles.titleContainer}>
                        <Icon name="reduce-capacity" size={24} color="#323232" />
